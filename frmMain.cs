    ...
    public partial class frmMain : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void OpenFile(string fileName, bool showMessage)
        {
            ...
            lock (this)
            {
                ...
                try
                {
                    ...
                    this.Text = "VagSuite [ " + Path.GetFileName(Tools.Instance.m_currentfile) + " ]";
        ...
        private SymbolCollection DetectMaps(string filename, out List<CodeBlock> newCodeBlocks, out List<AxisHelper> newAxisHelpers, bool showMessage, bool isPrimaryFile)
        {
            ...
            if (parser != null)
            {
                ...
                info.EcuType = Tools.Instance.DetermineFileType(filename, isPrimaryFile).ToString();
                ...
                if (!info.EcuType.StartsWith("EDC15P") && !info.EcuType.StartsWith("EDC15VM") && !info.EcuType.StartsWith("EDC16") && info.EcuType != string.Empty && showMessage)
                {
                    frmInfoBox infobx = new frmInfoBox("No EDC15P/VM/EDC16 file [" + info.EcuType + "] " + Path.GetFileName(filename));
                }
                ...
                if (showMessage && (parser is EDC15PFileParser || parser is EDC15P6FileParser || parser is EDC16FileParser))
                {

...
namespace VAGSuite
{
    ...
    internal class Candidate
    {
        ...
        public EDCFileType Type { get; set; }

        public Candidate(byte[] pattern, EDCFileType type)
        {
            Pattern = pattern;
            Type = type;
        }
    ...
    public sealed class Tools
    {
        ...
        public EDCFileType DetermineFileType(string fileName, bool isPrimaryFile)
        {
            ...
            if (allBytes == null || allBytes.Length < 65536) return EDCFileType.Unknown;

            // Helper to search for a byte pattern (exact contiguous match)
            bool ContainsPattern(byte[] pattern)
            {
                if (pattern.Length > allBytes.Length) return false;
                for (int i = 0; i <= allBytes.Length - pattern.Length; i++)
                {
                    bool match = true;
            ...
            {
                // EDC17 family – most common variants
                new Candidate(Encoding.ASCII.GetBytes("EDC17C74"), EDCFileType.EDC17C74),
                new Candidate(Encoding.ASCII.GetBytes("EDC17C64"), EDCFileType.EDC17C64),
                /*
                new Candidate(Encoding.ASCII.GetBytes("EDC17C54"), EDCFileType.EDC17C54),
                new Candidate(Encoding.ASCII.GetBytes("EDC17C56"), EDCFileType.EDC17C56),
                new Candidate(Encoding.ASCII.GetBytes("EDC17C46"), EDCFileType.EDC17C46),
                new Candidate(Encoding.ASCII.GetBytes("EDC17C50"), EDCFileType.EDC17C50),
                new Candidate(Encoding.ASCII.GetBytes("EDC17C41"), EDCFileType.EDC17C41),
                new Candidate(Encoding.ASCII.GetBytes("EDC17C06"), EDCFileType.EDC17C06),

                new Candidate(Encoding.ASCII.GetBytes("EDC17CP44"), EDCFileType.EDC17CP44),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP45"), EDCFileType.EDC17CP45),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP54"), EDCFileType.EDC17CP54), // if you have this variant
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP14"), EDCFileType.EDC17CP14),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP20"), EDCFileType.EDC17CP20),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP24"), EDCFileType.EDC17CP24),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP04"), EDCFileType.EDC17CP04),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP02"), EDCFileType.EDC17CP02),
                new Candidate(Encoding.ASCII.GetBytes("EDC17CP09"), EDCFileType.EDC17CP09),

                new Candidate(Encoding.ASCII.GetBytes("EDC17U01"), EDCFileType.EDC17U01),
                new Candidate(Encoding.ASCII.GetBytes("EDC17U05"), EDCFileType.EDC17U05),*/

                // EDC16 family
                new Candidate(Encoding.ASCII.GetBytes("EDC16CP34"), EDCFileType.EDC16CP34),
                new Candidate(Encoding.ASCII.GetBytes("EDC16CP35"), EDCFileType.EDC16CP35),
                new Candidate(Encoding.ASCII.GetBytes("EDC16U34"), EDCFileType.EDC16U34),
                new Candidate(Encoding.ASCII.GetBytes("EDC16U31"), EDCFileType.EDC16U31),
                new Candidate(Encoding.ASCII.GetBytes("EDC16U1"), EDCFileType.EDC16U1),   // older U1
                new Candidate(Encoding.ASCII.GetBytes("EDC16C39"), EDCFileType.EDC16C39),
                new Candidate(Encoding.ASCII.GetBytes("EDC16C35"), EDCFileType.EDC16C35),
                new Candidate(Encoding.ASCII.GetBytes("EDC16C31"), EDCFileType.EDC16C31),
                new Candidate(Encoding.ASCII.GetBytes("EDC16CP"), EDCFileType.EDC16CP),   // generic CP if no exact match
            };
            ...
            else if (info.EcuType.Contains("EDC17C64"))
            {
            ...
            {
                if (boschnumber.StartsWith("EDC17"))
                {
                    if (isPrimaryFile) m_currentFileType = EDCFileType.EDC17;
                    return EDCFileType.EDC17;
                }
        ...
        public IEDCFileParser GetParserForFile(string filename, bool isPrimaryFile)
        {
            ...
            switch (fileType)
            {
                ...
                case EDCFileType.EDC16:
                    ...
                    break;
                case EDCFileType.EDC16U1: //?
                case EDCFileType.EDC16U31:
                case EDCFileType.EDC16U34:
                    parser = new EDC16UFileParser();
                    break;
                case EDCFileType.EDC16C31: //?
                case EDCFileType.EDC16C35:
                case EDCFileType.EDC16C39:
                    parser = new EDC16CFileParser();
                    break;
                case EDCFileType.EDC16CP: //?
                case EDCFileType.EDC16CP34:
                case EDCFileType.EDC16CP35:
                    parser = new EDC16CPFileParser();
                    break;

                case EDCFileType.EDC17C74:
                    parser = new EDC17C74FileParser();
                    break;

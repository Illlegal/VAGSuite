...
namespace VAGSuite
{
    public class SymbolHelper
    {
        ...
        private int _x_axis_maxvalue = 1;

        public int X_axis_maxvalue
        {
            get { return _x_axis_maxvalue; }
            set { _x_axis_maxvalue = value; }
        }
        private int _y_axis_maxvalue = 1;

        public int Y_axis_maxvalue
        {
            get { return _y_axis_maxvalue; }
            set { _y_axis_maxvalue = value; }
        }
        private int _z_axis_maxvalue = 1;

        public int Z_axis_maxvalue
        {
            get { return _z_axis_maxvalue; }
            set { _z_axis_maxvalue = value; }
        }
